...
two arrays have the "same" elements, with the same multiplicities. "Same" means, here, that the elements in
...
is the square of 121, 20736 the square of 144, 361 the square of 19, 25921 the
...
const comp = (array1, array2) => {
  ...
  if(array2 === null) {
    ...
    if (JSON.stringify(rootedNums) === JSON.stringify(array2)) {
      return true;
    } else {
      return false;
    }
